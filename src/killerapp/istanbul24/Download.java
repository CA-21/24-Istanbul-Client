...
public class Download
{
	...
	public static Long downloadFile(Activity currentActivity, String url, String fileName)
	{
		return downloadFile(currentActivity, url, fileName, fileName, "File is downloading.");
	}
	
	public static Long downloadFile(Activity currentActivity, String url, String fileName, String title, String description)
	{
